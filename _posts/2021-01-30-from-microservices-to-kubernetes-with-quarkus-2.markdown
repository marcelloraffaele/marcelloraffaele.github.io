...
![frontend]({{site.baseurl}}/assets/img/starevent-quarkus-2/frontend-example1.png)


You can see the prometheus page visiting [http://127.0.0.1:9090](http://127.0.0.1:9090):

![prometheus]({{site.baseurl}}/assets/img/starevent-quarkus-2/prometheus-example1.png)
...
![grafana]({{site.baseurl}}/assets/img/starevent-quarkus-2/grafana-example1.png)
